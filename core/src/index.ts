...
export const InitGame: (socket: Socket) => void = (socket: Socket) => {
    ...
    Provider.playerInfoRepository.addPlayer("1", { id: "1", name: "Test Player 1" })
    Provider.playerStateRepository.setPlayerState("1", new PlayerState(0, 0, 100, 2))

    Provider.playerInfoRepository.addPlayer("2", { id: "2", name: "Test Player 2" })
    Provider.playerStateRepository.setPlayerState("2", new PlayerState(-50, 0, 100, 2))
    ...
    socket.on(SocketIOEvents.CONNECTION, (clientSocket: Socket) => {
        ...
        Provider.connectionsRepository.addConnection(connection)
        ...
        clientSocket.on(SocketIOEvents.DISCONNECT, () => {
            Provider.connectionsRepository.removeConnection(connection.connectionId)
